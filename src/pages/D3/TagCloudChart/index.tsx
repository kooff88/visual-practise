...
import D3TagCloudChart from "../components/charts/D3TagCloudChart";
import styles from './index.less';



const TagCloudChart: React.FC<{}> = (props) => {
            ...
            <Row gutter={10}>
                <Col className="gutter-row" md={24}>
                    <div className="gutter-box">
                        <Card title="D3 标签云图" bordered={false}>
                            <D3TagCloudChart data={data} />
                        </Card>
                    </div>
                </Col>
            </Row>
